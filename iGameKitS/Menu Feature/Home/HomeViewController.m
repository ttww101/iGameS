...
@property (nonatomic, strong) mGameViewController *feature1VC;
...
- (void)viewDidLoad {
    ...
    [dVC setStartPage:@"https://gacyou.github.io/PrivacyPolicy.html"];
...
- (void)setContainerViewController {
    mGameViewController *vc1 = [mGameViewController new];
    vc1.view.backgroundColor = [UIColor colorWithRed:0.0f/255.0f
                                               green:111.0f/255.0f
                                                blue:152.0f/255.0f
                                               alpha:1.0f];
    
    gameViewController *game = [gameViewController new];
    userCenterViewController *uc = [userCenterViewController new];
    
    [self.mContainerVCArr addObject:vc1];
    [self.mContainerVCArr addObject:game];
    [self.mContainerVCArr addObject:uc];
...
- (NSArray<UIImage *> *)tabBarImages {
    return @[[UIImage imageNamed:@"down_button"], [UIImage imageNamed:@"down_button"], [UIImage imageNamed:@"more@2x"]];
}
    ...
    for (UIViewController *vc in self.mContainerVCArr) {
        if (i == button.tag) {
            ...
            switch (button.tag) {
                case 0:
                {
                    UIStoryboard *storyboard=[UIStoryboard storyboardWithName:@"mGame" bundle:[NSBundle mainBundle]];
                    mGameViewController *controllerD = [storyboard instantiateViewControllerWithIdentifier:@"mGame"];
                ...
                case 2:
                {
                    ...
                    mGameViewController *controllerD = [storyboard instantiateViewControllerWithIdentifier:@"userCenter"];
                    [self.navigationController pushViewController:controllerD animated:YES];
                }
                    break;
                default:
